...
class Collision {
	public:
		...
		static inline bool IsColliding(Rect &a, Rect &b, double angleOfA, double angleOfB) {
			angleOfA = angleOfA / 180 * acos(-1);
			angleOfB = angleOfB / 180 * acos(-1);

			Vec2 A[] = { Vec2( a.x, a.y + a.height ),
				Vec2( a.x + a.width, a.y + a.height ),
				Vec2( a.x + a.width, a.y ),
				Vec2( a.x, a.y )
			};
			Vec2 B[] = { Vec2( b.x, b.y + b.height ),
				Vec2( b.x + b.width, b.y + b.height ),
				Vec2( b.x + b.width, b.y ),
				Vec2( b.x, b.y )
			};
